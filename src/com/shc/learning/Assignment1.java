...
public class Assignment1 {
	 ...
	 * @param args
	 */
	private static final Logger log = Logger.getLogger(Assignment1.class);
	...
	public void doSomething(Integer i, int j) {
		System.out.println("Do something Integer long this");
	}
	...
	public void doSomething(int l, int i) {
		System.out.println("Do something eye eye");
	}
